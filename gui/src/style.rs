...
// Neutral, balanced darkness.
pub const C_BG: Color = Color { r: 53.0/255.0, g: 53.0/255.0, b: 53.0/255.0, a: 1.0 };

// ~Yale Blue #284b63 (Primary Accent)
// Deep, striking academic prestige. (Replaces C_MAYA)
pub const C_MAYA: Color = Color { r: 40.0/255.0, g: 75.0/255.0, b: 99.0/255.0, a: 1.0 };

// ~Stormy Teal #3c6e71 (Secondary Accent / Highlights)
// Dark, moody swirling skies. (Replaces C_SKY)
pub const C_SKY: Color = Color { r: 60.0/255.0, g: 110.0/255.0, b: 113.0/255.0, a: 1.0 };

// ~Dust Grey #d9d9d9 (Text)
// Subtle dusted stone. (Replaces C_TEXT)
pub const C_TEXT: Color = Color { r: 217.0/255.0, g: 217.0/255.0, b: 217.0/255.0, a: 1.0 };

// ~White #ffffff (Highlights / Important Data)
// Crispness of a blank page. (Replaces C_PETAL)
pub const C_PETAL: Color = Color::WHITE;

// === TRANSLUCENT DERIVATIVES ===

// Cards: Graphite background, slightly lightened by overlay, or transparent Yale Blue?
// Let's go with transparent Yale Blue to create that "Stormy" atmosphere over the Graphite.
pub const C_CARD_BG: Color = Color { r: 40.0/255.0, g: 75.0/255.0, b: 99.0/255.0, a: 0.25 }; 

// Hover: White with very low opacity
...
pub fn card(_theme: &Theme) -> container::Style {
    container::Style {
        ...
        border: Border {
            // Very subtle Dust Grey border for edge definition
...
pub fn list_item(_theme: &Theme) -> container::Style {
    container::Style {
        // Subtle Graphite shift for rows
...
pub fn tab_active(_theme: &Theme, _status: button::Status) -> button::Style {
    button::Style {
        // Yale Blue for active tabs
        background: Some(Background::Color(C_MAYA)),
        text_color: C_TEXT, // Dust Grey on Blue
...
pub fn ghost_btn(_theme: &Theme, status: button::Status) -> button::Style {
    match status {
        button::Status::Hovered => button::Style {
            ...
            text_color: C_SKY, // Stormy Teal on hover
...
// Separator line
pub fn separator() -> iced::widget::Rule<'static> {
